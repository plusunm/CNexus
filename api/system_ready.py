...
Non-Hang Kernel v1: when isolation is enabled (default), /v1/system/ready is IO-free.
"""
...
def system_ready_warming_payload() -> Dict[str, Any]:
    """Fast boot response while BrainMemoryRuntime initializes in the background."""
