...
Write-Host "  python scripts/l3_probe_report.py --base-dir `"$DataDir`" --json"
Write-Host "  python scripts/l3_probe_report.py --base-dir `"$DataDir`" --g1 --json"
Write-Host "  python scripts/l3_probe_report.py --base-dir `"$DataDir`" --g2 --json"
Write-Host "  python scripts/l3_probe_report.py --base-dir `"$DataDir`" --g3 --json"
Write-Host "  python scripts/l3_probe_report.py --base-dir `"$DataDir`" --g4 --json"
Write-Host "  python scripts/l3_probe_report.py --base-dir `"$DataDir`" --g5 --json"
Write-Host "  python scripts/l3_probe_report.py --base-dir `"$DataDir`" --g6 --json"
Write-Host "  python scripts/l3_probe_report.py --base-dir `"$DataDir`" --g7 --json"
Write-Host "  python scripts/semantic_safety_check.py --strict --v3"
Write-Host "  python scripts/semantic_safety_v5_isolation.py"
Write-Host "  python scripts/semantic_safety_v6_dissolution.py"
Write-Host "  python scripts/l8_field_report.py"
Write-Host "  python scripts/run_l8g8_influence_test.py --mode full --text"
Write-Host "  python scripts/observation_gateway_check.py --base-dir `"$DataDir`""
Write-Host "  python scripts/observation_p2_ingest.py --base-dir `"$DataDir`" file-tail --path <external.log>"
Write-Host "  python scripts/observation_stream_l2.py --base-dir `"$DataDir`" --text --poll"
Write-Host ""
